...
> **Status:** Draft proposal · Last updated: 2026-07-06 · Baseline version: [v3.8.0](https://github.com/gritsenko/Pix2d/releases/tag/v3.8.0)
>
...
- [ ] Onion-skin layer leaks into export — [#230](https://github.com/gritsenko/Pix2d/issues/230). Export must render only visible content layers; add a golden-image test comparing export with onion skin on/off.
- [ ] Box-selection target movement interrupt — [#225](https://github.com/gritsenko/Pix2d/issues/225) (labeled Hot). Reproduce with pointer-event unit test if possible.
- [ ] Pixel-perfect stroke flicker — [#241](https://github.com/gritsenko/Pix2d/issues/241).
- [ ] Slider mouse-wheel support on desktop — [#242](https://github.com/gritsenko/Pix2d/issues/242) (small UX win, cheap).
- [ ] Palette slider interruption — [#236](https://github.com/gritsenko/Pix2d/issues/236).
...
- [ ] Crash telemetry: Sentry already integrated on Android (opt-in, fatal-only — keep that policy). Evaluate extending the same opt-in model to desktop.
