...
public class ArtworkPreviewViewModel : Pix2dViewModelBase
{
    ...
    public List<ScaleItem> AvailableScales { get; set; } = new();
    ...
    public ArtworkPreviewViewModel(AppState appState, IMessenger messenger)
    {
        if (IsDesignMode)
            return;
        ...
        for (var i = 1; i <= 10; i++) AvailableScales.Add(new ScaleItem(i, SelectScaleCommand));
