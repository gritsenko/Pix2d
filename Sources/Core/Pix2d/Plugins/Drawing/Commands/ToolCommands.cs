...
public class ToolCommands : CommandsListBase
{
    ...
    public Pix2dCommand ActivateEyedropperTool => GetCommand(
        ...
        EditContextType.Sprite,
        () => CoreServices.ToolService.ActivateTool<EyedropperTool>());
