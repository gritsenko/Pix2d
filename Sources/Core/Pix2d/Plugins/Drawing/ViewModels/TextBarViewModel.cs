...
namespace Pix2d.Plugins.Drawing.ViewModels
{
    public class TextBarViewModel : Pix2dViewModelBase
    {
        ...
        public ObservableCollection<FontItemVm> Fonts { get; set; } = new ObservableCollection<FontItemVm>();

        public FontItemVm SelectedFont
        {
            get => Get<FontItemVm>();
            set => Set(value);
        }
    ...
    public class FontItemVm
    {
        public FontItemVm(string fontName)
        {
            Name = fontName;
        }
