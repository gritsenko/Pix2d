...
namespace System
{
    ...
    public class SimpleContainer
    {
        ...
        {
            this._entries = new List<ContainerEntry>(entries);
        }
        ...
        {
            object singleton = null;
            RegisterHandler(service, service.Name,
        ...
        public object GetInstance(Type service, string key)
        {
            ...
            if (DelegateType.GetTypeInfo().IsAssignableFrom(service.GetTypeInfo()))
            {
                ...
                var factoryFactoryMethod =
                    factoryFactoryType.GetRuntimeMethod("Create", new Type[] {typeof(SimpleContainer)});
