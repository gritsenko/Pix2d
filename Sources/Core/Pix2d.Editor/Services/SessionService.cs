...
namespace Pix2d.Services
{
    public class SessionService : ISessionService
    {
        ...
        public SessionService(IProjectService projectService, IAppState appState, IFileService fileService, ISettingsService settingsService, IMessenger messenger)
        {
