...
public static class StaticResources
{
    ...
    public static class Fonts
    {
        public static FontFamily IconFontSegoe { get; } =
            new FontFamily(new Uri("avares://Pix2d.Editor/Assets/Fonts/"), "segmdl2.ttf#Segoe MDL2 Assets");
        
        public static FontFamily Pix2dThemeFontFamily { get; } =
            new FontFamily(new Uri("avares://Pix2d.Editor/Assets/Fonts/"), "pix2d.ttf#pix2d");
       
        public static FontFamily IconsThemeFontFamily { get; } =
            new FontFamily(new Uri("avares://Pix2d.Editor/Assets/Fonts/"), "icons.ttf#icons");
        //public static FontFamily FluentIcons { get; } = 
        //    new FontFamily(new Uri("avares://Pix2d.Editor/Assets/Fonts/"), "Segoe Fluent Icons.ttf#Segoe Fluent Icons");
    }
    ...
    public static IBitmap CheckerTilesBitmap { get; set; } = new Bitmap(GetAsset("avares://Pix2d.Editor/Assets/BackgroundTile100.png"));
