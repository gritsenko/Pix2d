...
");
    ...
    {
        var renderScale = TopLevel.GetTopLevel(this).RenderScaling;
        float scaledWidth = (float)(Bounds.Width * renderScale);
        float scaledHeight = (float)(Bounds.Height * renderScale);
        gl.Viewport(0, 0, (int)scaledWidth, (int)scaledHeight);
        ...
        var projection = Matrix4x4.CreatePerspectiveFieldOfView((float)(Math.PI / 4), (float)(scaledWidth / scaledHeight), 0.01f, 1000);
