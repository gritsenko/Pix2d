                    ...
                    new StackPanel()
                        ...
                        .Children(
                            ...
                            new AppButton()
                                ...
                                .Label(L("Rotate"))
                                .ToolTip(L(SpriteEditCommands.Rotate90.Tooltip)()),
                            ...
                            new AppButton()
                                ...
                                .Label(L("Flip X"))
                                .ToolTip(L(SpriteEditCommands.FlipHorizontal.Tooltip)()),
                            ...
                            new AppButton()
                                ...
                                .Label(L("Flip Y"))
                                .ToolTip(L(SpriteEditCommands.FlipVertical.Tooltip)()),

                            // MIRROR X
                            new AppToggleButton()
                                .Classes(ButtonClass)
                                .IsChecked(() => MirrorX, v => MirrorX = v)
                                .Content(new PathIcon()
                                    .With(IconStyle)
                                    .Data(Geometry.Parse(
                            ...
                            new AppToggleButton()
                                .Classes(ButtonClass)
                                .IsChecked(() => LockAxis, v => LockAxis = v)
                                .Content(new PathIcon()
                                    .With(IconStyle)
                                    .Data(Geometry.Parse(
                            ...
                            new AppButton()
                                ...
                                .Label(L("Import"))
                                .ToolTip(L(EditCommands.Import.Tooltip)()),

                            //Resize
                            new AppButton()
                                .Classes(ButtonClass)
                                .Command(ViewCommands.ToggleCanvasSizePanelCommand)
                                .IsEnabled(!IsAnimationPlaying)
                                .Content(new PathIcon()
                                    .With(IconStyle)
                                    .Data(Geometry.Parse(
