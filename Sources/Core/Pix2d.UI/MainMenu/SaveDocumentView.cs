            ...
            .Child(
                new StackPanel()
                    ...
                    .Children(
                        ...
                        new TextBlock()
                            .Margin(0, 8, 0, 8)
                            .Text(L("Export to other formats")),
                                    ...
                                    .Content(
                                        new Grid()
                                            ...
                                            .Children(
                                                new Path()
                                                    .Data(Geometry.Parse(
                                                        "M0,1.800781L0,16.199219 18,16.199219 18,1.800781z M0.71875,2.519531L17.28125,2.519531 17.28125,11.878906 13.433594,11.878906 10.914063,10.078125 8.789063,10.078125 7.316406,8.609375 5.566406,8.960938 4.015625,6.632813 0.71875,9.929688z M13.5,4.679688C12.609375,4.679688 11.878906,5.410156 11.878906,6.300781 11.878906,7.191406 12.609375,7.921875 13.5,7.921875 14.390625,7.921875 15.121094,7.191406 15.121094,6.300781 15.121094,5.410156 14.390625,4.679688 13.5,4.679688z M13.5,5.398438C14,5.398438 14.398438,5.800781 14.398438,6.300781 14.398438,6.800781 14,7.199219 13.5,7.199219 13,7.199219 12.601563,6.800781 12.601563,6.300781 12.601563,5.800781 13,5.398438 13.5,5.398438z M3.902344,7.765625L5.234375,9.757813 7.082031,9.390625 8.492188,10.800781 10.683594,10.800781 13.203125,12.601563 17.28125,12.601563 17.28125,15.480469 0.71875,15.480469 0.71875,10.949219z"))
                                                    .Fill(Brushes.White)
                                                    .Width(48)
                                                    .Height(48)
                                                    .Stretch(Stretch.Uniform),
                                    ...
                                    .Content(
                                        new Grid()
                                            ...
                                            .Children(
                                                new Path()
                                                    .Data(Geometry.Parse(
                                                        "M 0 2.16016 L 0 14.3984 L 6.12109 14.3984 L 6.12109 15.1211 L 3.23828 15.1211 C 3.23047 15.1211 3.21875 15.1211 3.20703 15.1211 C 3.00781 15.1289 2.85156 15.2969 2.86328 15.4961 C 2.87109 15.6953 3.04297 15.8516 3.23828 15.8398 L 14.7617 15.8398 C 14.8906 15.8398 15.0117 15.7734 15.0781 15.6602 C 15.1406 15.5508 15.1406 15.4102 15.0781 15.2969 C 15.0117 15.1875 14.8906 15.1172 14.7617 15.1211 L 11.8789 15.1211 L 11.8789 14.3984 L 18 14.3984 L 18 2.16016 Z M 0.71875 2.87891 L 17.2813 2.87891 L 17.2813 13.6797 L 0.71875 13.6797 Z M 1.80078 3.96094 L 1.80078 5.03906 L 3.23828 5.03906 L 3.23828 3.96094 Z M 14.7617 3.96094 L 14.7617 5.03906 L 16.1992 5.03906 L 16.1992 3.96094 Z M 1.80078 6.48047 L 1.80078 7.55859 L 3.23828 7.55859 L 3.23828 6.48047 Z M 14.7617 6.48047 L 14.7617 7.55859 L 16.1992 7.55859 L 16.1992 6.48047 Z M 1.80078 9 L 1.80078 10.0781 L 3.23828 10.0781 L 3.23828 9 Z M 14.7617 9 L 14.7617 10.0781 L 16.1992 10.0781 L 16.1992 9 Z M 1.80078 11.5195 L 1.80078 12.6016 L 3.23828 12.6016 L 3.23828 11.5195 Z M 14.7617 11.5195 L 14.7617 12.6016 L 16.1992 12.6016 L 16.1992 11.5195 Z M 6.83984 14.3984 L 11.1602 14.3984 L 11.1602 15.1211 L 6.83984 15.1211 Z"))
                                                    .Fill(Brushes.White)
                                                    .Width(48)
                                                    .Height(48)
                                                    .Stretch(Stretch.Uniform),
