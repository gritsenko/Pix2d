...
public class LockedFunctionView : ViewBase
{
    ...
    /// IsLocked
    /// </summary>
    public static readonly DirectProperty<LockedFunctionView, bool> IsLockedProperty
        = AvaloniaProperty.RegisterDirect<LockedFunctionView, bool>(nameof(IsLocked), o => o.IsLocked, (o, v) => o.IsLocked = v);
